...
👉 **[Admin Panel Tutorials](/docs/tutorials/admin-panel/getting-started)**

👉 **[DSL References](/docs/references/dsl)**
...
- 🟢 **Build an admin panel to help administrators of the pet store manage data.**
- 🔵 Create backend commands for task scheduling. 👉 [CLI](cli)
- ⚪ Integrate AI for chatbots, image generation, and enhanced user input. 👉 [AI Integration](ai-integration)s
